...
const Navbar = () => {
  ...
  return (
    <header className="px-4 lg:px-6 h-14 flex items-center justify-between bg-background text-primary-foreground">
      ...
      <nav className={`${isMenuOpen ? 'block' : 'hidden'} w-full lg:block lg:w-auto bg-background text-primary-foreground lg:bg-transparent lg:text-foreground`} id="navbar-menu">
        <ul className="flex flex-col lg:flex-row gap-4 lg:gap-6 lg:items-center">
          <li>
